...
public class MainPageSendMain extends BasePage {
    ...
    public MainPageSendMain start() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("com.google.android.gm:id/to")).sendKeys("zzzm0naxzzz@gmail.com");
        driver.findElement(By.id("com.google.android.gm:id/subject")).sendKeys("lol");
        driver.findElement(By.id("com.google.android.gm:id/body")).sendKeys("kek");
